      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            >
              ...
              />
              <span className="dark:text-white light:text-slate-800 font-bold text-xl transition-all duration-300 group-hover:text-nexrank-purple">
                Singularity
              </span>
            </button>
            ...
            <div className="flex space-x-4 mt-6">
              <a 
                ...
                className="dark:text-gray-400 light:text-slate-500 hover:text-nexrank-purple transition-all duration-300 hover:scale-110"
              >
                <Instagram size={20} />
              </a>
              <a 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/graphics" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors">Grafica</Link></li>
              <li><Link to="/it" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors">Informatica</Link></li>
              <li><Link to="/video-editing" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors">Video Editing</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/social-commitment" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors">Impegno Sociale</Link></li>
              <li><Link to="/contact" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors">Contatti</Link></li>
              <li><Link to="/work-with-us" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors">Lavora con noi</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:info.singularityy@gmail.com" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors">
        ...
        <div className="border-t dark:border-white/10 light:border-slate-300/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <a href="mailto:info.singularityy@gmail.com" className="dark:text-gray-400 light:text-slate-600 hover:text-nexrank-purple transition-colors flex items-center hover:scale-105 duration-300">
